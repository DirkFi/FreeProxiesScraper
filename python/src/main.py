...
async def main():
    ...
    # 创建代理管理器
    proxy_provider = FreeProxyProvider(check_url="https://www.basketball-reference.com")
    proxy_manager = ProxyManager(providers=[proxy_provider])
    ...
    # 先设置团队数据存储
    scraper.set_storage(team_storage)
